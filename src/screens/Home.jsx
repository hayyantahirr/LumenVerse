const Home = () => {
  return (
    <>
      ...
      {/* Section 1 Start */}
      <section class="bg-[#001229] w-[80%] mx-auto">
        <div class="container px-6 py-10 mx-auto">
          <div class="lg:-mx-6 lg:flex lg:items-center">
            ...
            <div class="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
              ...
              <h3 class="mt-6 text-lg font-medium text-blue-500">Jane Doe</h3>
              <p class="text-gray-600 dark:text-gray-300">CEO at LumenVerse</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <section class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
            ...
            <div class="p-8 bg-blue-500 border border-transparent rounded-lg dark:bg-blue-600">
              ...
              <div class="flex items-center mt-8 -mx-2">
                ...
                <div class="mx-2">
                  <h1 class="font-semibold text-white">Alisson Schrader</h1>
